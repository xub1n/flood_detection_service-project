...
### 💧 POC
***
가상환경에서의 무궁무진한 창작을 진행하기 위해 POC를 메타버스, 로블록스로 진행하였습니다.<br>
해당지역의 침수면적과 위험도, 헌재와 15분뒤, 30분 뒤, 60분 뒤의 침수상황을 실시간으로 알려줄 수 있게 환경을 구성해보았습니다.<br>
**침수면적에 따라 물 높이가 차오르는 것도 중점적으로 나타낼 수 있으며, 위의 결과들로 실시간 도시침수 감지 서비스를 효과적으로 구현할 수 있었습니다.**<br></br>
<img width="962" alt="스크린샷 2023-04-16 오후 8 37 41" src="https://user-images.githubusercontent.com/106679267/232307297-a6990500-b20c-4264-a362-594a6d443455.png"><br></br>

### 💧 Benefit
***
도시침수 예측시스템을 구축하여 얻을 수 있는 기대효과는 다음과 같습니다.<br></br>
